...
class _PerformanceScreenState extends State<PerformanceScreen> {
  ...
  List<Result> _nodesCompleted = List<Result>();
  List<Result> _nodesNotCompleted = List<Result>();
  List<Result> _nodesNotVisit = List<Result>();
  ...
  _generateData() {
    VisitProvider().getVisitCount().then((value) {
      ...
      setState(() {
        _seriesData = List<charts.Series<Result, String>>();
