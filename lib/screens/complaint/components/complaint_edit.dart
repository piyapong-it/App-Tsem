...
class _ComplaintEditState extends State<ComplaintEdit> {
  ...
  List<product.Result> _nodeProduct = List<product.Result>();
  List<UdcResult> _nodeStatus = List<UdcResult>();
  product.Result _selectProduct = product.Result();

  List<question.Result> _nodeQuestion = List<question.Result>();
  List<question.Result> _nodeQuestionFilter = List<question.Result>();
  List<quiz.Result> _nodeQuiz = List<quiz.Result>();
