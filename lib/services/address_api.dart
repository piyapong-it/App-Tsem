...
class AddressApi {
  ...
  Future<Province> fetchProvince() async {
    try {
      ...
      final uri =
          Uri.http(endpoint, "/api/address/province");
  ...
  Future<District> fetchDistrict(
    ...
    try {
      ...
      final uri = Uri.http(endpoint, "/api/address/"+ province + "/district" );
    ...
    Future<SubDistrict> fetchSubDistrict(
    ...
    try {
     ...
     final uri = Uri.http(endpoint, "/api/address/"+ district + "/subdistrict" );
