...
class OutletApi {
  ...
  Future<Outlets> fetchMyOutlet() async {
    try {
      ...
      final uri =
          Uri.http(endpoint, "/api/outlets/getOutletsBySalesID/" + _jdecode);
  ...
  Future<Outlets> fetchMapOutlet() async {
    try {
      ...
      final uri =
          Uri.http(endpoint, "/api/outlets/getOutletsMapBySalesID/" + _jdecode);
      Response response = await _dio.get(uri.toString(),
          options: Options(headers: {"Authorization": "Bearer $_token"}));
  ...
  Future<OutletsNearby> fetchOutletNearby(
    ...
    try {
      ...
      final uri = Uri.http(endpoint, "/api/outlets/getOutletsNearby");
  ...
  Future<OutletDetail> fetchOutletDetail({String outletid}) async {
    try {
      ...
      final uri =
          Uri.http(endpoint, "/api/outlets/getOutletByOutletID/" + outletid);
  ...
  Future<TypeStatus> fetchOutletTypeStatus(
    ...
    try {
      ...
      final uri = Uri.http(endpoint, "/api/outlets/getOutletTypeStatus");
      Response response = await _dio.post(uri.toString(),
