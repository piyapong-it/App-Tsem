...
class TsemApi {
  ...
  Future<User> fetchUser({userId, password}) async {
      try {
      final uri = Uri.http(endpoint , "/api/users/login");
  ...
  Future<Udc> fetchUdc({String id, String md, String key}) async {
    try {
      ...
      final uri = Uri.http(endpoint, "/api/misc/getUDC", queryParameters);
  ...
  Future<SalesFolder> fetchSalesFolder() async {
    try {
      ...
      final uri = Uri.http(endpoint, "/api/misc/getSalesFolder");
  ...
  Future<UploadImage> uploadImageDefect(
    ...
    try {
      ...
      final uri = Uri.http(endpoint, "/upload");
      ...
      Response response = await _dio.post(uri.toString(), data: formData,
       options: Options(headers: {"Authorization": "Bearer $_token"}));
  ...
  Future<DefectTrans> fetchDefectTrans(
    ...
    try {
      ...
      final uri =
          Uri.http(endpoint, "/api/misc/getDefectTrans", queryParameters);
  ...
  Future<DmLmessage> updateDefect(
    ...
    try {
      ...
      final uri = Uri.http(endpoint, "/api/misc/updateDefect");
  ...
  Future<UploadImage> uploadImageTask({String outletid, File imageFile}) async {
    try {
      ...
      final uri = Uri.http(endpoint, "/upload/uploadTaskImage");
  ...
  Future<TaskTrans> fetchMyTaskTrans({String taskstatus}) async {
    try {
      ...
      final uri =
          Uri.http(endpoint, "/api/misc/getMyTaskTrans", queryParameters);
  ...
  Future<TaskTrans> fetchTaskTrans({String outletid, String taskid}) async {
    try {
      ...
      final uri = Uri.http(endpoint, "/api/misc/getTaskTrans", queryParameters);
  ...
  Future<DmLmessage> updateTask(
    ...
    try {
      ...
      final uri = Uri.http(endpoint, "/api/misc/updateTask");
      Response response = await _dio.post(uri.toString(), data: {
        "taskid": taskid,
        "outletid": outletid,
  ...
  Future<UploadImage> uploadImageOutlet(
    ...
    try {
      ...
      final uri = Uri.http(endpoint, "/upload/uploadOutletImage");
  ...
  Future<DmLmessage> updateOutletImage(
    ...
    try {
      ...
      final uri = Uri.http(endpoint, "/api/misc/updateOutletImage");
      Response response = await _dio.post(uri.toString(),
  ...
  Future<complainttrans.ComplaintTrans> fetchComplaintTrans(
    ...
    try {
      ...
      final uri =
          Uri.http(endpoint, "/api/misc/getComplaintTrans", queryParameters);
  ...
  Future<Questions> fetchComplaintQuestion({String category}) async {
    try {
      ...
      final uri =
          Uri.http(endpoint, "/api/misc/getCPQuestion", queryParameters);
  ...
  Future<quiz.ComplaintQuiz> fetchComplaintQuiz({String complaintid}) async {
    try {
      ...
      final uri =
          Uri.http(endpoint, "/api/misc/getComplaintQuiz", queryParameters);
      Response response = await _dio.get(uri.toString(),
       options: Options(headers: {"Authorization": "Bearer $_token"}));
       print(response);
      var jsonResponse = json.decode(response.data);
  ...
  Future<DmLmessage> updateCompliantTrans(
    ...
    try {
      ...
      final uri = Uri.http(endpoint, "/api/misc/updateComplaintTrans");
      ...
      Response response = await _dio.post(uri.toString(), data: {
        ...
        "complaintdate": DateFormat('yyyy-MM-dd').format(complaintTrans.rDate),
  ...
  Future<UploadImage> uploadImageComplaint(
    ...
    try {
      ...
      final uri = Uri.http(endpoint, "/upload/uploadComplaintImage");
  ...
  Future<DmLmessage> updateCompliantQuiz({quiz.Result complaintQuiz}) async {
    try {
      ...
      final uri = Uri.http(endpoint, "/api/misc/updateComplaintQuiz");
